...
- [Preparing for Instal](/docs/7-1/deploy/-/knowledge_base/d/preparing-for-install)
- [マニュアルで@product@をインストールする](/docs/7-1/deploy/-/knowledge_base/d/installing-liferay-manually)
...
@product@をインストールする前に、`portal-ext.properties`ファイルの`liferay.home`プロパティを介して[*Liferay Home*](/docs/7-1/deploy/-/knowledge_base/d/installing-liferay#liferay-home)のフォルダのロケーションを設定する必要があります。このファイルを使用して、 必要になる可能性のある[他の@product@プロパティ](@platform-ref@/7.1-latest/propertiesdoc/portal.properties.html)を上書きすることもできます 。
