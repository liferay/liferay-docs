---
header-id: configuring-elasticsearch-for-liferay-0-ja
---
...
the
[Installing Elasticsearch article](/discover/deployment/-/knowledge_base/7-1/installing-elasticsearch-ja).
