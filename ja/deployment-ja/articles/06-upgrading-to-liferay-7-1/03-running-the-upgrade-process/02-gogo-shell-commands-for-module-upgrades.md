# モジュールアップグレード用のGogoシェルコマンド[](id=gogo-shell-commands-for-module-upgrades)
...
## モジュールアップグレードプロセスの一覧表示[](id=listing-module-upgrade-processes)
...
## モジュールアップグレードの実行[](id=executing-module-upgrades)
...
## アップグレードステータスの確認[](id=checking-the-upgrade-status)
...
## 検証プロセスの実行[](id=executing-verify-processes)
