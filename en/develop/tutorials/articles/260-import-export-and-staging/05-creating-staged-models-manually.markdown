...
[Adapting Your Business Logic to Build Staged Models](/docs/7-1/tutorials/-/knowledge_base/t/understanding-staged-models#adapting-your-business-logic-to-build-staged-models)
...
framework used for
[relating assets](/docs/7-1/user/-/knowledge_base/u/defining-content-relationships))
...
1.  Create a new interface that extends one of the
    [staged model interfaces](/docs/7-1/tutorials/-/knowledge_base/t/understanding-staged-models#staged-model-interfaces)
...
4.  Now you need to adapt your existing business logic to call the provided
    ...
    Once you've created
    [Staged Model Data Handlers](/docs/7-1/tutorials/-/knowledge_base/t/developing-staged-model-data-handlers),
