...
| `cachePolicy` | `string` | The offline mode setting. See the [Offline section](/docs/7-1/reference/-/knowledge_base/r/web-content-list-screenlet-for-android#offline) for details. |
