...
| `offlinePolicy` | `string` | The offline mode setting. The default is `remote-first`. See [the Offline section](/docs/7-1/reference/-/knowledge_base/r/comment-list-screenlet-for-ios#offline) for details. |
