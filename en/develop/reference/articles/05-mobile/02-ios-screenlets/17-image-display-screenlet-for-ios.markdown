---
header-id: image-display-screenlet-for-ios
---
...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See the [Offline section](/docs/7-1/reference/-/knowledge_base/r/image-display-screenlet-for-ios#offline) for details. |
