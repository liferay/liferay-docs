...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See the [Offline section](/docs/7-1/reference/-/knowledge_base/r/ddllistscreenlet-for-ios#offline) for details. |
