---
header-id: video-display-screenlet-for-ios
---

# Video Display Screenlet for iOS
...
| `offlinePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/7-1/reference/-/knowledge_base/r/video-display-screenlet-for-ios#offline) for details. |
