...
[enabling staging](/docs/7-1/user/-/knowledge_base/u/enabling-staging).
...
Once you've
[created a Site pages variation](/docs/7-1/user/-/knowledge_base/u/creating-multi-and-single-page-variations),
...
Once you've
[created a page variation](/docs/7-1/user/-/knowledge_base/u/creating-multi-and-single-page-variations),
