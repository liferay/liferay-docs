...
The default administrator account's name and email address are from the
...
installing @product@. Make sure to  update this email address to a valid one
that can be dedicated to notifications. 
