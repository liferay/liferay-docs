...
<aside class="alert alert-info">
  <span class="wysiwyg-color-blue120">This document has been updated and ported to <a href="https://learn.liferay.com/dxp/latest/en/installation-and-upgrades/maintaining_a_liferay_dxp_installation.html">Liferay Learn</a> and is no longer maintained here.</span>
</aside>
