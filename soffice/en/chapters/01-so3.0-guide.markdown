...
If you want to create tasks for a site, then a Tasks portlet will have to be 
...
You can read about it in the user guide in [http://www.liferay.com/documentation/liferay-portal/6.2/user-guide/-/ai/features-of-liferays-wcm-liferay-portal-6-2-user-guide-02-en](the section on managing content).
