...
*Connections*, *Following*, or *My Contacts*. If you are a member of a site, 
you can also choose to display only the members of that site. There's also a 
search bar so you can search for specific users. The Contacts Center is also 
capable of storing contacts that aren't portal users, making it a great one stop 
...
task to let them know it has been resolved.
