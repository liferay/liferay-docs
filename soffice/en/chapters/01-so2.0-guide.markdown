...
After deploying Social Office, check your server console log. There should not
be any console errors during installation. If you encounter any console errors,
please refer to the Validating your Social Office Installation section.
...
## Validating your Social Office Installation
