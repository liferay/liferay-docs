...
downloaded Liferay apps by their `.lpkg` file extensions. They're available
...
the option to select either a major or a minor revision each time you edit or
...
but there's no way to specify a major/minor revision or enter a change log
message.
...
![Figure 1.23: Social Office EE allows you to specify a major or minor revision
and enter a change log message each time you edit or check in a
document.](../../images/so-ee-doclib-comments.png)
