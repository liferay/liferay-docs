# Working Smarter with Liferay Social Office [](id=lp-2-0-soen01-working-smarter-with-liferay-social-office-0)
...
![Figure 1.x: The Social Office 2.0 welcome theme provides a clean and attractive login screen.](../../images/so-welcome-theme1.png)
...
![Figure 1.x: Tip](../../images/tip.png) **Warning:** The Social Office welcome theme will overwrite any pages and customizations that have already been made to the guest site.
...
![Figure 1.x: Editing the default site's settings](../../images/so-welcome-theme2.png)

4. Set the theme of the site back to the classic theme or to your theme of choice.

![Figure 1.x: Editing the default site's settings](../../images/so-welcome-theme3.png)
...
![Figure 1.x: The Sites portlet lets you customize your sites list and create new Social Office sites with a simple wizard.](../../images/sites-portlet.png)
...
![Figure 1.x: The default Dashboard applications are designed to inform you about recent portal activities and upcoming events, and to help you manage your personal tasks.](../../images/dashboard-applications.png)
...
![Figure 1.x: Contacts Centers allows users to follow each other Twitter-style and set up Linked-In style connections.](../../images/contacts-center.png)
...
![Figure 1.x: Microblogs allow users to broadcast their thoughts to a chosen audience.](../../images/microblogs.png)
...
![Figure 1.x: The Private Messaging Interface functions just like an email client for use within a Social Office instance.](../../images/private-messaging.png)
...
![Figure 1.x: The Tasks portlet lets you create tasks and assign them to yourself or others. You can view tasks that have been assigned to you and tasks that you've created.](../../images/tasks-portlet.png)
...
![Figure 1.x: User's Profile pages show relevant professional information, contacts, and status updates](../../images/profile-page.png)
...
![Figure 1.x: The Social Office site wizard lets you quickly and easily set up sites for team collaboration.](../../images/new-site-wizard1.png)
...
![Figure 1.x: You can choose a site template to use to create your new site and you can choose which template pages to include.](../../images/new-site-wizard2.png)
...
![Figure 1.x: The Join/Leave button appears at the bottom of the navigation menus for Social Office sites.](../../images/join-site-button.png)
...
![Figure 1.x: Social Office's sites come with pre-build pages and applications that facilate team-based collaboration.](../../images/social-office-site.png)
...
1. In your new 6.1.1 portal bundle, add the following properties into your `portal-ext.properties` file:
    ...
    #5.2.7 uses permission algorith 5 (comment out once data migration is done)
    permissions.user.check.algorithm=5
    permissions.view.dynamic.inheritance=false

    #6.1.1 uses permission algorithm 6(comment in once data migration is done)
    #permissions.user.check.algorithm=6
    #permissions.view.dynamic.inheritance=false

    #This is so that the document library uses the same storage method.
    dl.hook.impl=com.liferay.documentlibrary.util.FileSystemHook

    #You do not want to index on startup/upgrade, make sure reindex is not happening while deploy Social Office packager
    index.on.startup=false
    index.on.upgrade=false

    #Pointing liferay to data folder of SO 1.5 (this may be different then yours)
    resource.repositories.root={your data folder}

    #Below values are taken from teh default 5.2 legacy properties in the portal folder
    #Default 5.2
