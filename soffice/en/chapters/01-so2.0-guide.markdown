...
have two options: you can purchase the app or you can use a free 30-day trial.

![Figure 1.x: If you'd like to try out Social Office EE, click on the *30-Day
...
![Figure 1.x: As with other apps on Liferay Marketplace, you can purchase Social
...
![Figure 1.x: To deploy your Social Office EE license, enter your order id
...
![Figure 1.5: Editing the default site's
...
![Figure 1.7: Tip](../../images/tip.png) **Warning:** Installing the Social
...
## Social Office features [](id=lp-2-0-soen01-social-office-features-0)
...
### Social Office EE Features [](id=lp-2-0-soen01-social-office-ee-features-0)
...
![Figure 1.21: The Social Office Configurations page of the Control Panel
...
![Figure 1.22: Social Office EE allows you to specify a major or minor revision
...
![Figure 1.23: Social Office EE allows you to comment on particular versions of
...
![Figure 1.24: Social Office EE allows you to specify a major or minor revision
and enter a change log message each time you edit or check in a
