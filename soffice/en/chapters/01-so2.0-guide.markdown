...
Next, let's discuss how to uninstall Social Office.

### Uninstalling Social Office 

If you'd like to uninstall Social Office, you can navigate to the *Marketplace*
&rarr; *Purchased* page of the Control Panel and click on *Uninstall*. However,
after you've uninstalled Social Office from Marketplace, you need to manually
revert the friendly URL of the Welcome page. 
...
confirm that these plugins have been successfully deployed. Your server's
console log should indicate whether or each plugin has been successfully
deployed. The plugins listed in italics belong only to either the CE or EE
versions of Social Office.
...
To actually start using Social Office, you need to grant the Social Office User
role to one or more users. If you're using Social Office EE, you can access the
Social Office Configurations portlet which provides a shortcut for this process.
Please refer to the *Using Social Office* section for more details about the
Social Office User role and the features provided by Social Office.
...
assistance through the [Social Office Forum](http://www.liferay.com/community/forums/-/message_boards/category/1670998) or from [Liferay Support](http://www.liferay.com/group/customer/home). Next, let's discuss how to use Social Office
