...
![Figure 1.3: The Social Office 2.0 welcome theme provides a clean and attractive login screen.](../../images/so-welcome-theme1.png)
...
![Figure 1.4: Tip](../../images/tip.png) **Warning:** The Social Office welcome theme will overwrite any pages and customizations that have already been made to the guest site.
...
![Figure 1.5: Editing the default site's settings](../../images/so-welcome-theme2.png)

4. Set the theme of the site back to the classic theme or to your theme of choice.

![Figure 1.6: Editing the default site's settings](../../images/so-welcome-theme3.png)
...
![Figure 1.7: The Dashboard navigation menu contains links to each private page of your personal site as well as a link to your public Profile page. Clicking the Social Office logo takes you to your Dashboard.](../../images/dashboard-menu.png)
...
![Figure 1.8: The Sites portlet lets you customize your sites list and create new Social Office sites with a simple wizard.](../../images/sites-portlet.png)
...
![Figure 1.9: The default Dashboard applications are designed to inform you about recent portal activities and upcoming events, and to help you manage your personal tasks.](../../images/dashboard-applications.png)
...
![Figure 1.10: Contacts Centers allows users to follow each other Twitter-style and set up Linked-In style connections.](../../images/contacts-center.png)
...
![Figure 1.11: Microblogs allow users to broadcast their thoughts to a chosen audience.](../../images/microblogs.png)
...
![Figure 1.12: The Private Messaging Interface functions just like an email client for use within a Social Office instance.](../../images/private-messaging.png)
...
![Figure 1.13: The Tasks portlet lets you create tasks and assign them to yourself or others. You can view tasks that have been assigned to you and tasks that you've created.](../../images/tasks-portlet.png)
...
![Figure 1.14: User's Profile pages show relevant professional information, contacts, and status updates](../../images/profile-page.png)
...
![Figure 1.15: The Social Office site wizard lets you quickly and easily set up sites for team collaboration.](../../images/new-site-wizard1.png)
...
![Figure 1.16: You can choose a site template to use to create your new site and you can choose which template pages to include.](../../images/new-site-wizard2.png)
...
![Figure 1.17: The Join/Leave button appears at the bottom of the navigation menus for Social Office sites.](../../images/join-site-button.png)
...
![Figure 1.18: Social Office's sites come with pre-build pages and applications that facilate team-based collaboration.](../../images/social-office-site.png)
