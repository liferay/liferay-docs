...
5.  [Test Upgrading a @product@ Backup Copy](https://web-community-beta.us-west-1.lfr.cloud/web/guest/docs/7-2/deploy/-/knowledge_base/d/test-upgrading-a-product-backup-copy)
    ...
    3.  [Remove Duplicate Web Content and Structure Field Names](https://web-community-beta.us-west-1.lfr.cloud/web/guest/docs/7-2/deploy/-/knowledge_base/d/pruning-the-database)

    4.  [Find and Remove Unused Objects](https://web-community-beta.us-west-1.lfr.cloud/web/guest/docs/7-2/deploy/-/knowledge_base/d/pruning-the-database)
    ...
    5.  [Test @product@ with its Pruned Database Copy](https://web-community-beta.us-west-1.lfr.cloud/web/guest/docs/7-2/deploy/-/knowledge_base/d/pruning-the-database#test-product-with-its-pruned-database-copy)
    ...
    6.  [Install the New  @product@ Version on a Test Server](https://web-community-beta.us-west-1.lfr.cloud/web/guest/docs/7-2/deploy/-/knowledge_base/d/upgrading-your-test-server-and-database)
