...
| Directory | Removed | Originally deprecated in 7.1. |
| Liferay Documentum Connector EE | Removed | Originally deprecated in 7.1. |
| Microblogs | Removed | Originally deprecated in 7.1. |
| Quick Note | Removed | Originally deprecated in 7.1. |
| Recent Documents | Removed | Originally deprecated in 7.1. |
| Social Networking | Removed | Originally deprecated in 7.1. |
