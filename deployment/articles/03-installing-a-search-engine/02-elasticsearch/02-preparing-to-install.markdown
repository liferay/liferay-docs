...
[embedded Elasticsearch engine](/docs/7-2/deploy/-/knowledge_base/deploy/configuring-elasticsearch-for-liferay-0#embedded-vs-remote-operation-mode)
...
[installation guide](/docs/7-2/deploy/-/knowledge_base/deploy/installing-elasticsearch)
