...
[Customer Portal](https://customer.liferay.com/group/customer/downloads)
(DXP) or [Liferay Downloads](https://www.liferay.com/downloads) (Portal CE).
@product-ver@ supports deployment to Wildfly 11. Even if you want
...
[DXP](https://customer.liferay.com/group/customer/downloads)
...
[*Liferay Home*](//installing-liferay#liferay-home)
...
4. These other `osgi` subfolders are created when the instance starts for the first time:
