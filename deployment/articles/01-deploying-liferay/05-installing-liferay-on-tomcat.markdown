...
| **Important:** 
| [Prepare for the install](/docs/7-2/deploy/-/knowledge_base/deploy/prepare-for-install)
| before continuing. 
...
[built-in data source (recommended)](/docs/7-2/deploy/-/knowledge_base/deploy/preparing-for-install#using-the-built-in-data-source),
skip this section.
...
[built-in mail session](/docs/7-2/deploy/-/knowledge_base/deploy/configuring-mail#products-built-in-mail-session),
skip this section. 
