...
found in either the [`discover`](discover), [`develop`](develop), or
[`distribute`](distribute) folder. The repository folders follow a
[structure](#structure) similar to the Liferay Developer Network's layout of
pages and articles. To add an article to LDN's
