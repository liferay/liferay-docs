...
![Figure 4.8: You'll see a page displaying the name of the service method, its required parameters, its return type, possible exceptions that can be thrown, and a form for entering the parameter.](../../images/invoking-sb-generated-json-ws.png)
