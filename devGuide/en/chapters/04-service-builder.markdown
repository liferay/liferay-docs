...
utilities and can be accessed via SOAP, JSON, or Java RMI. Although the number
...
<!-- Really, Java RMI? I've never seen that implemented anywhere. Where did you
find out about this? Do we ever talk about accessing services this way? -Rich -->
...
choice, such as JPA, Hibernate, or Ibatis. <!-- I remember this sentence from
something very old; where did you get it from? I never knew anybody who used
IBatis; it was not very popular. IBatis is now retired from the
Apache project. We should never mention it. http://ibatis.apache.org -Rich -->If you're inclined to take this
