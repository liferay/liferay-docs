...
### Defining the Columns (Attributes) for Each Service Entity [](id=defining-columns-for-entity-liferay-portal-6-2-dev-guide-en)
...
### Defining Relationships Between Service Entities [](id=relating-service-entities-liferay-portal-6-2-dev-guide-en)
...
### Defining Ordering of Service Entity Instances [](id=define-ordering-of-service-entities-liferay-portal-6-2-dev-guide-04-en)
...
## Writing Local Service Classes [](id=writing-local-service-classes-liferay-portal-6-2-dev-guide-04-en)
...
## Calling Local Services [](id=calling-local-services-liferay-portal-6-2-dev-guide-04-en)
...
## Writing Remote Service Classes [](id=writing-remote-service-classes-liferay-portal-6-2-dev-guide-04-en)
...
### Calling Remote Services [](id=calling-remote-services-liferay-portal-6-2-dev-guide-04-en)
