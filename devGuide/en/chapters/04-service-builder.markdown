...
these files in detail later on in this section.
...
We'll add the database interaction methods to this service layer class. Add the
following methods to the `EventLocalServiceImpl` class:
