...
#### HTML Content Type [](id=html-content-type-liferay-portal-6-2-dev-guide-08-en)
...
#### URL Content Type [](id=url-content-type-liferay-portal-6-2-dev-guide-08-en)
...
## Accessing Third-Party Applications from Your Gadget [](id=accessing-third-party-applications-from--liferay-portal-6-2-dev-guide-08-en)
...
### Gadget to Gadget [](id=gadget-to-gadget-liferay-portal-6-2-dev-guide-08-en)
...
### Communicating Between Portlets and Gadgets [](id=communicating-between-portlets-and-gadge-liferay-portal-6-2-dev-guide-08-en)
...
## Using the Gadget Editor [](id=using-the-gadget-editor-liferay-portal-6-2-dev-guide-08-en)
