...
2.  Open Preference page for Liferay &rarr; Installed SDKs (Go to Window &rarr; Preferences &rarr; Liferay &rarr; Installed SDKs).
...
![Figure 7.x](../../images/ide-add-portlet-to-page.png)
