...
![Figure 8.1: Creating an Ext plugin](../../images/07-ext-plugins-1.png)
...
### Using the terminal [](id=liferay-portal-6-1-create-ext-plugins-in-terminal)
...
### Ext Plugin Packaging Requirements for JBoss 7 [](id=liferay-portal-6-1-ext-plugin-packaging-requirements-for-jboss)
