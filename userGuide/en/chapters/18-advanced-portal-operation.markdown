...
6.0.x, but not from 5.1.x to 6.0.x. If you needed to upgrade over several major
...
Liferay 6.1 and later versions, these have been combined into Documents and
Media. If you were using Liferay's Image Gallery to store images, these can be
migrated over during an upgrade, but you'll have to take some extra steps first. 
...
2. By default, Liferay 6.1 used the SHA algorithm for password encryption.
    ...
    and new users' passwords will be encrypted with the new algorithm.
