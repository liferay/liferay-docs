...
a new form. Give your form a name and look at the available fields. You don't
have to use all the available fields, so feel free to delete any that you don't
think need to be filled out for the particular task. When you're done, click
*Save* and then choose your new form from the *Actions* button next to it.
