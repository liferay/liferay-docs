...
![Figure 10.x: Workflow for Documents and Media must be enabled at the folder level. Edit a folder to select a workflow.](../../images/folder-edit.png)
...
![Figure 10.x: You can use the document type restrictions and workflow of the parent folder or you can define specific document type restrictions and workflow for this folder.](../../images/folder-workflow.png)
...
![Figure 10.x: The Workflow Configuration page of the Control Panel lists the resources for which can select a workflow for your chosen scope.](../../images/workflow-configuration.png)
