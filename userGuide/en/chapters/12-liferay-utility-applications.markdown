...
![Figure 12.8: The Software Catalog with Nothing
Installed](../../images/marketplace-software-catalog.png)
...
of the screen a message that says “Content for <Site>, where <Site> is the site
you were on when you selected the control panel from the Dockbar. If you want to
administer the software catalog for a different site, you can select it from the
selection box.

![Figure 12.9: Populated Software Catalog from
liferay.com](../../images/marketplace-populated-software-catalog.png)
...
![Figure 12.10: Adding a Product to the Software
Catalog](../../images/marketplace-adding-product-to-software-catalog.png)
...
![Figure 12.11: Adding a Product Version to the Software
Catalog](../../images/marketplace-adding-product-version-software-catalog.png)
...
preview screen shots and download your software—and you don't have to build any
of those pages yourself. Simply configure your software in the portlet and all
...
![Figure 12.12: Knowledge Base Display
Portlet](../../images/liferay-collaboration-kb-display-portlet.png)
...
![Figure 12.13: New Knowledge Base
...
![Figure 12.15: Knowledge Base Control Panel
Page](../../images/liferay-collaboration-kb-control-panel.png)
...
![Figure 12.16: Adding a New Template From the Control
Panel](../../images/liferay-collaboration-kb-new-template.png)
...
![Figure 12.17: Knowledge Base Article
Portlet](../../images/liferay-collaboration-kb-article-portlet.png)
...
![Figure 12.18: Knowledge Base Section
Portlets](../../images/liferay-collaboration-kb-section-portlet.png)
...
![Figure 12.19: Knowledge Base Search
Portlet](../../images/liferay-collaboration-kb-search-portlet.png)
...
![Figure 12.20: Knowledge Base Category Navigation
Portlet](../../images/liferay-collaboration-kb-catnavandkbdisplay-portlets.png)
