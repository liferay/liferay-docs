...
<!--   What's the new chapter # on user group sites? Ch. 15?    -->
...
<!--   What's the new chapter # on Default User Private Layouts?   -->
...
Like many web sites you may visit, any portal running on Liferay can be set up to use Facebook for sign in. This makes it easier for users to sign in to your site, since they won't need to remember another user name and password, For more information on setting up Facebook sign on, see chapter 12.
<!--  Ch. 8?   -->
