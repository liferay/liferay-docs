...
![Figure 8.x: The Members Portlet](../../images/XX-social-networking-members-portlet.png)
...
![Figure 8.x: The Meetups Portlet](../../images/XX-social-networking-meetups.png)
...
![Figure 8.x: The Activities Portlet](../../images/XX-social-networking-activities.png)
...
![Figure 8.x: Social Networking Portlets in a Facebook-like Layout](../../images/XX-social-networking-personal-portlets.png)
...
![Figure 8.x: The Map Portlet](../../images/map-portlet.png)
...
![Figure 8.x: Creating the Site Template](../../images/social-networking-site-template.png)
...
![Figure 8.x: Social Profile Site Template](../../images/social-networking-profile-template.png)
...
![Figure 8.x: OpenSocial Gadget displayed on a page](../../images/open-social-gadget.png)
...
![Figure 8.x: OpenSocial Gadget in your application list](../../images/open-social-in-context.png)
