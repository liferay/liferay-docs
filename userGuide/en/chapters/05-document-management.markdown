...
![Figure 5.1: Initial View of the Documents and Media
...
![Figure 5.4: Adding a New Document Type](../../images/05-new-document-type.png)
...
![Figure 5.5: Selecting Additional Metadata
...
![Figure 5.7: Adding a new repository](../../images/05-new-repository.png)
...
![Figure 5.8: Viewing a repository](../../images/05-repository.jpg)
...
braces '{' and '}' in the browser's address bar.
    ...
    ![Figure 5.9: The repository ID can be found by displaying the repository's
