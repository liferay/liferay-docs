...
<!-- | Jonathon: Please document all options for all fields. I know it's tedious and a pain, but we need to do it. And never say something is self-explanatory. | -->
...
<!-- | Jonathon: please regenerate the screenshot; it still shows TISA stuff, not the example you describe above. | -->

![Figure 5.4: Entering a new data record.](../../images/05-ddl-add-record.png)

<!-- | Jonathon: please modify the text below to reference the example you created above. | -->
