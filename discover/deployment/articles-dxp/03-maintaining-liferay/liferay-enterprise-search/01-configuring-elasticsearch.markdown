...
In embedded mode, Elasticsearch search is run with Liferay as a library in the
...
As mentioned above, Liferay's Elasticsearch adapter module is very configurable.
