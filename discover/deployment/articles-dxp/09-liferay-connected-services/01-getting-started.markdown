...
5.  Select whether the environment allows elastic subscriptions. Elastic 
    ...
    see 
    [the documentation on elastic subscriptions](/discover/deployment/-/knowledge_base/7-0/using-lcs#elastic-subscriptions). 
...
6.  Enable the LCS services you want to use with servers that connect to this 
    ...
    -   **Portal Properties Analysis:** Enabling this lets LCS compare the 
        ...
        [security sensitive properties](/discover/deployment/-/knowledge_base/7-0/using-lcs#what-lcs-stores-about-your-liferay-servers). 
...
[preconfiguration steps](/discover/deployment/-/knowledge_base/7-0/lcs-preconfiguration) 
for that server. 
