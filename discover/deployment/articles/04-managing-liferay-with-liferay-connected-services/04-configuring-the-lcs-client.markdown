...
and distribution on the Welcome screen and then click *Download*. In the 
following screenshot, Liferay Portal EE 6.2 is selected.
...
similar to the Welcome screen, where you select your portal's version, 
distribution, and then click *Download*. 
...
Select your portal's version and distribution, and then click *Download*.
