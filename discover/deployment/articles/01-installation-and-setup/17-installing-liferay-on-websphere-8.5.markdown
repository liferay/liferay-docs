...
2. Click the Advanced profile creation option and then click *Next*. Why
   ...
   information about these options, please see the WebSphere documentation. 
    ...
    ![Figure 1.x: Choose the Advanced profile option to specify your own settings.](../../images/websphere-01-profile.png)
...
![Figure 1.x: The Summary page shows you what you selected, giving you the chance to go back and change something if it's not exactly what you want.](../../images/websphere-03-summary.png)
...
![Figure 1.x: WebSphere JDBC providers](../../images/02-websphere-jdbc-providers.png) 
...
17. Type *user* into the search terms and click *Go*.
    ...
    ![Figure 1.x: Modifying data source properties in WebSphere](../../images/02-modifying-data-source-properties-in-websphere.png) 
...
configuration. 
   ...
   ![Figure 1.x: Enabling security can be done by checking one box, but it still needs to be configured. ](../../images/websphere-05-liferay-enable-security.png)
...
2. Select the Liferay application and click *Start*. 
    ...
    ![Figure 1.x: While Liferay is starting, WebSphere displays this spinny little graphic. Don't watch it too closely, or you might get hypnotized.](../../images/websphere-04-liferay-starting.png)
