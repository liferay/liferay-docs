...
For every major portal release, Liferay works with external security partners
to perform security scans and penetration testing.
...
## Protection Against Known Attacks and Security Vulnerabilities

Liferay follows OWASP Top 10 (2013) and CWE/SANS Top 25 lists to protect the
portal.

For example, Liferay's persistence layer is generated and maintained by the
...
stored in the original form as submitted by the user.

Liferay includes built-in protection against CSRF attacks, Local File
Inclusion, Open Redirects, Uploading and serving files of dangerous types,
Content Sniffing, Clickjacking, Path Traversal, and many other common attacks.
