...
Please note that in order to use NTLM SSO, your Liferay Portal instance authentication
type must be set to screen name. If this is not acceptable for your Liferay Portal
