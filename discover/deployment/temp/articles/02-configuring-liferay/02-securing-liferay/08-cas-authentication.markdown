...
to be supported by Liferay Portal. Please follow the documentation for CAS to install
...
Once your CAS server is up and running, you can configure Liferay Portal to use it.
...
will be directed to the CAS server to sign in to Liferay Portal.
