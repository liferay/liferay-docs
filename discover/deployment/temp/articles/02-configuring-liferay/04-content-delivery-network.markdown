...
Here, you'll first discover the perks of using a CDN in Liferay Portal and learn about
general guidelines for using a CDN in your Liferay Portal instance. Then,
you'll learn the steps to configure a CDN for your Liferay Portal instance. It's time to
...
Liferay Portal only works with CDNs that can dynamically retrieve requested resources
...
the content from Liferay Portal.
...
Once you've configured Liferay Portal to use a CDN (see below), the CDN not only serves
...
There are several properties in Liferay Portal that enable you to configure your CDN
...
it's used in Liferay Portal, it's time to set one up for yourself. You can set your CDN
...
the CDN, and Liferay Portal generates URLs to them that replace the old host with your
new CDN host.
