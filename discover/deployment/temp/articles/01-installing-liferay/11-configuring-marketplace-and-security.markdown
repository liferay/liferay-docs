...
the hood, it not only provides the store, it also provides Liferay Portal's
...
Please note that if you installed Liferay Portal manually, there may be further
