...
set](/participate/liferaypedia/-/wiki/Main/Metadata+Set). When you add
a document belonging to a specific document type, a form appears for picking the
...
You can access files stored in Google applications, such as Google Drive and
Google Photos, through the Document Library. This integration isn't available by
default, but you can get it by installing the Liferay Google Drive™ Plugin from
the [Marketplace](https://web.liferay.com/marketplace). 
...
released to accelerate the availability of useful and cutting-edge feature. This
status may change without notice. Please download and use Labs apps at
your own discretion. 
...
brings up Google's file picker to select files from your Google Drive or your
photos. Select the Google file you want to link to and click *Publish*. 
...
You now know how to access Google docs from your document libraries. Next,
