...
go to the *Site Settings* &rarr; *Advanced* &rarr; *Analytics* page for the site
to which you wish to add analytics. Copy the Javascript tracking code provided 
by your analytics platform into corresponding field for your service. Now all 
