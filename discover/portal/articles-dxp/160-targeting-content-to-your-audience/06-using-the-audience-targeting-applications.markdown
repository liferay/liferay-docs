...
which content to display to a user based on the user segments that the
...
[Categorizing Pages and Content for User Segments](/develop/tutorials/-/knowledge_base/7-1/categorizing-pages-and-content-for-user-segments)
tutorial.
