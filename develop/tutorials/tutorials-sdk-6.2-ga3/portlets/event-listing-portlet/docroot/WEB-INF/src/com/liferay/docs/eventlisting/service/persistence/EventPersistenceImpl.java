...
import com.nosester.portlet.eventlisting.service.persistence.EventUtil;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, EventImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERID =
		new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			...
			EventModelImpl.DATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public Event findByUserId_First(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
	 ...
	 */
	@Override
	public Event fetchByUserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Event fetchByUserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Event> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	...
	public Event[] findByUserId_PrevAndNext(long eventId, long userId,
		...
		try {
			...
			array[0] = getByUserId_PrevAndNext(session, event, userId,
					orderByComparator, true);

			array[1] = event;

			array[2] = getByUserId_PrevAndNext(session, event, userId,
					orderByComparator, false);
	...
	protected Event getByUserId_PrevAndNext(Session session, Event event,
	...
	public void removeByUserId(long userId) throws SystemException {
		for (Event event : findByUserId(userId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(event);
		}
	}
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "event.userId = ?";
	...
	public Event updateImpl(com.nosester.portlet.eventlisting.model.Event event)
		...
		if (isNew || !EventModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((eventModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { eventModelImpl.getOriginalUserId() };
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.nosester.portlet.eventlisting.model.Event")));
	...
	private static final String _FILTER_SQL_SELECT_EVENT_WHERE = "SELECT DISTINCT {event.*} FROM Event_Event event WHERE ";
	private static final String _FILTER_SQL_SELECT_EVENT_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {Event_Event.*} FROM (SELECT DISTINCT event.eventId FROM Event_Event event WHERE ";
	private static final String _FILTER_SQL_SELECT_EVENT_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN Event_Event ON TEMP_TABLE.eventId = Event_Event.eventId";
	private static final String _FILTER_SQL_COUNT_EVENT_WHERE = "SELECT COUNT(DISTINCT event.eventId) AS COUNT_VALUE FROM Event_Event event WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "event";
	private static final String _FILTER_ENTITY_TABLE = "Event_Event";
	private static final String _ORDER_BY_ENTITY_ALIAS = "event.";
	private static final String _ORDER_BY_ENTITY_TABLE = "Event_Event.";
