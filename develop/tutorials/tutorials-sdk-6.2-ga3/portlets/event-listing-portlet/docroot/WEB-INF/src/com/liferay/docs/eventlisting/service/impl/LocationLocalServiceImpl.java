 ...
 * {@link com.liferay.docs.eventlisting.service.LocationLocalService} interface.
 *
 * <p>
...
public class LocationLocalServiceImpl extends LocationLocalServiceBaseImpl {
	 ...
	 * com.liferay.docs.eventlisting.service.LocationLocalServiceUtil} to access
	 * the location local service.
	 */

	public Location addLocation(long userId, long groupId, String name,
		...
		long locationId = counterLocalService.increment(Location.class
				.getName());
	...
	public void addLocationResources(Location location,
			boolean addGroupPermissions, boolean addGuestPermissions)
			throws PortalException, SystemException {

		resourceLocalService.addResources(location.getCompanyId(),
				location.getGroupId(), location.getUserId(),
				Location.class.getName(), location.getLocationId(), false,
	...
	public void addLocationResources(Location location,
		...
		resourceLocalService.addModelResources(location.getCompanyId(),
				location.getGroupId(), location.getUserId(),
				Location.class.getName(), location.getLocationId(),
	...
	public void addLocationResources(long locationId,
		...
		addLocationResources(location, addGroupPermissions, addGuestPermissions);
	}
	...
	public List<Location> getLocationsByGroupId(long groupId, int start, int end)
			throws SystemException {
	...
	public Location updateLocation(long userId, long locationId, String name,
			String description, String streetAddress, String city,
			String stateOrProvince, String country,
			ServiceContext serviceContext) throws PortalException,
			SystemException {
