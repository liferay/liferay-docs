...
run the `service-builder` blade command outlined in step 2 of the previous
...
folder and define it in the `settings.gradle` file too. For example, an example
`tasks` project would look like this:
