...
![Figure 1: Liferay 6's architecture, shown in this figure, is still generally valid in @product-ver@.](../../../images/from-liferay-6-liferay-6-architecture.png)
...
Liferay's apps. You have learned some key concepts that are new for Liferay 6
