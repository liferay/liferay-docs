...
@product@ 7 is a new major version of the Liferay platform and as such it includes
...
deployed or none of it. In @product@ 7, many out of the box portlets, features,
...
What has not changed? Even though there are many improvements in @product@ 7,
...
adapted to @product@ 7's API) through a compatibility layer.
...
![Figure 1: Liferay 6's architecture, show in this figure, is still generally valid in @product@ 7.](../../../images/from-liferay-6-liferay-6-architecture.png)

The most significant change (and improvement) over this architecture is that
@product@ 7 is no longer a single large Java EE Web Application. Liferay has been
...
The figure below represents @product@ 7's architecture from a structural
perspective.

![Figure 2: @product@ 7 is composed of the Liferay Core, independent application modules, and App Suites, each with their own set of application and framework modules.](../../../images/from-liferay-6-core-suites-and-apps.png)

#### Liferay Core [](id=liferay-core)

As it name implies, it's @product@ 7's central and most important part. The
...
The beauty of the @product@ 7 ecosystem is that it is made up of simple
...
Let's consider the structure of a @product@ 7 app.
...
@product@ 7 and have become acquainted with the structure used in Liferay's apps
for @product@ 7. You have learned some key concepts that are new for Liferay 6
developers and have been assured about developer features you've used in
previous Liferay releases that have been carried into @product@ 7.
