...
### Plugin Upgrade and Optimization Paths [](id=plugin-upgrade-and-optimization-paths)
 ...
 Hook - Language files | - [Override Portal language keys using a module with a resource bundle](/develop/tutorials/-/knowledge_base/7-0/overriding-language-keys)<br>- [Override module language keys using a module with a resource bundle and loader](/develop/tutorials/-/knowledge_base/7-0/overriding-language-keys) | Same |
