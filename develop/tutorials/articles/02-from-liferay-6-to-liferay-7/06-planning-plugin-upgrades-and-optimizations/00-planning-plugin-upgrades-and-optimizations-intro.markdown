...
### Plugin Upgrade and Optimization Paths [](id=plugin-upgrade-and-optimization-paths)
 ...
 Hook - Language files | Coming soon | - [Override Portal language keys using a module with a resource bundle](/develop/tutorials/-/knowledge_base/7-0/modifying-liferays-language-keys)<br>- [Override module language keys using a module with a resource bundle and loader](/develop/tutorials/-/knowledge_base/7-0/overriding-a-modules-language-keys)   |
 ...
 Hook - Properties | - If the property is now a [System Setting](/discover/portal/-/knowledge_base/7-0/system-settings), edit it there<br>- If the property is in the [liferay-hook.xml's DTD](@platform-ref@/7.0-latest/definitions/liferay-hook_7_0_0.dtd.html), then [adapt code to API](/develop/tutorials/-/knowledge_base/7-0/adapting-to-liferay-7s-api-with-the-code-upgrade-tool) and [resolve dependencies](/develop/tutorials/-/knowledge_base/7-0/resolving-a-plugins-dependencies) | Config Admin (`.cfg` files) |
 Hook - Service Wrappers | 1. [Adapt code to API](/develop/tutorials/-/knowledge_base/7-0/adapting-to-liferay-7s-api-with-the-code-upgrade-tool)<br>2. [Resolve dependencies](/develop/tutorials/-/knowledge_base/7-0/resolving-a-plugins-dependencies) | [Coming soon](https://issues.liferay.com/browse/LRDOCS-3336) |
