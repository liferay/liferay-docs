...
### Plugin Upgrade and Optimization Paths [](id=plugin-upgrade-and-optimization-paths)
 ...
 Hook - Event Actions (Portal/Session/Servlet Service/Shutdown/Startup) | [Upgrading Portal Property and Event Action Hooks](/develop/tutorials/-/knowledge_base/7-0/upgrading-portal-property-and-event-action-hooks) | None |
 ...
 Hook - Service Wrappers | [Upgrading Service Wrappers](/develop/tutorials/-/knowledge_base/7-0/upgrading-service-wrappers) | None |
 Hook - Servlet Filter | [Upgrading Servlet Filter Hooks](/develop/tutorials/-/knowledge_base/7-0/upgrading-servlet-filter-hooks) | None |
 ...
 Portlet - Servlet/JSP | [Upgrading a Servlet-based Portlet](/develop/tutorials/-/knowledge_base/7-0/upgrading-a-servlet-based-portlet) | None |
