...
project templating toolkit. In this article, we explain how to use it to create
a Liferay portlet project. With Archetype, you can use the same steps we detail
