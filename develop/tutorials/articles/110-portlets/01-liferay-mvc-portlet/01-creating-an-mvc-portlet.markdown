...
controller into [MVC Action Command classes](/docs/7-0/tutorials/-/knowledge_base/t/mvc-action-command), [MVC Render Command classes](/docs/7-0/tutorials/-/knowledge_base/t/mvc-render-command), and [MVC Resource Command classes](/docs/7-0/tutorials/-/knowledge_base/t/mvc-resource-command). 
