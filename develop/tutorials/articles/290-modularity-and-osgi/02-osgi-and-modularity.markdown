...
[create modules](/docs/7-0/tutorials/-/knowledge_base/t/starting-module-development)
like these anytime. 
...
If you were to
[deploy these modules to a DXP instance](/docs/7-0/tutorials/-/knowledge_base/t/starting-module-development#building-and-deploying-a-module),
...
[Maven](/docs/7-0/tutorials/-/knowledge_base/t/maven)

[Developing a Web Application](/docs/7-0/tutorials/-/knowledge_base/t/developing-a-web-application)

[Planning a Plugin Upgrade to Liferay 7](/docs/7-0/tutorials/-/knowledge_base/t/migrating-existing-code-to-liferay-7)
