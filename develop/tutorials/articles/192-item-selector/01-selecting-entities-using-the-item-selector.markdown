...
Experience app suites) containing criterion classes developers can use.
...
Return type order is also significant. Each view, from the criterion's return
types, uses the first return type it supports.
