---
header-id: defining-your-object-relational-map
---
...
| [Using Liferay Portal](/docs/6-1/user/-/knowledge_base/u/organizing-and-sharing-events-with-the-calendar).
...
1.  Create the Event Listing portlet project in your Liferay Plugins SDK using
    ...
    Liferay Projects](/docs/6-1/tutorials/-/knowledge_base/t/creating-new-liferay-projects)
    section. 
...
2.  Create the the Location Listng portlet and Event Listing portlet in the
    ...
    Plugins](/docs/6-1/tutorials/-/knowledge_base/t/creating-plugins) section. 
