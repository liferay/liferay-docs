---
header-id: leveraging-the-resources-importer
---
...
application is a tool that allows a theme developer to have
...
Liferay Marketplace must use the [resources importer](https://dev.liferay.com/participate/liferaypedia/-/wiki/Main/Resources+Importer). This ensures a uniform
...
to include resources with your theme. We also explain how to develop other types
of plugins that import resources into Liferay.
