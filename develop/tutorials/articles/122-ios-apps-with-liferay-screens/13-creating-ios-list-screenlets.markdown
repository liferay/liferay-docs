...
1.  In Xcode, create a new XIB file and name it according to 
    [these naming conventions](/docs/6-2/tutorials/-/knowledge_base/t/ios-best-practices#naming-conventions). 
...
[the tutorial on creating Connectors](/docs/6-2/tutorials/-/knowledge_base/t/create-and-use-a-connector-with-your-screenlet#creating-connectors). 
...
[offline mode](/docs/6-2/tutorials/-/knowledge_base/t/architecture-of-offline-mode-in-liferay-screens) 
...
[the tutorial on adding a Screenlet delegate](/docs/6-2/tutorials/-/knowledge_base/t/add-a-screenlet-delegate). 
...
[package it using the same steps you use to package a Theme](/docs/6-2/tutorials/-/knowledge_base/t/packaging-ios-themes), 
