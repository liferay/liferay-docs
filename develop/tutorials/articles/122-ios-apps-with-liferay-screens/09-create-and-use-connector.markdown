...
[the Interactor in the Screenlet creation tutorial](/develop/tutorials/-/knowledge_base/6-2/creating-ios-screenlets#creating-the-interactor) 
...
Connectors, see the 
[tutorial on the architecture of Liferay Screens for iOS](/develop/tutorials/-/knowledge_base/6-2/architecture-of-liferay-screens-for-ios). 
...
[naming convention](/develop/tutorials/-/knowledge_base/6-2/ios-best-practices#naming-conventions) 
