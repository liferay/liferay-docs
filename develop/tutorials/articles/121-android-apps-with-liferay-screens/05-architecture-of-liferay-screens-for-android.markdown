...
as the 
[Screenlet Library](/docs/6-2/reference/-/knowledge_base/r/screenlets-in-liferay-screens-for-android). 
...
This is explained in detail [here](/docs/6-2/tutorials/-/knowledge_base/t/accessing-the-liferay-session-in-android).
