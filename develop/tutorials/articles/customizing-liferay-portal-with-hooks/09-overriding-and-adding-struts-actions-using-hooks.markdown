...
3.  Create a new Struts action class. Consider extending [`BaseStrutsAction`](https://docs.liferay.com/portal/6.2/javadocs/com/liferay/portal/kernel/struts/BaseStrutsPortletAction.html).
