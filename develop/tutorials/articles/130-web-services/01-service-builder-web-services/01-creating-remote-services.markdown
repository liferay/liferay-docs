...
this plugin, you must [add it as a
dependency](/develop/tutorials/-/knowledge_base/7-0/configuring-dependencies) in
your `*-service` project's `build.gradle` file, and then apply it to your
