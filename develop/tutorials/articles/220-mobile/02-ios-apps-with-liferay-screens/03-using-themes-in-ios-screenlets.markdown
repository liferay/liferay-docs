...
- *Default*: Comes standard with a Screenlet. It's used by a Screenlet if no
  ...
  [architecture tutorial](/develop/tutorials/-/knowledge_base/7-1/architecture-of-liferay-screens-for-ios)
  for more details.
- *Flat7*: Demonstrates a Theme made from scratch. Refer to the 
  [Theme creation tutorial](/develop/tutorials/-/knowledge_base/7-1/creating-ios-themes) 
...
[writing your own Themes](/develop/tutorials/-/knowledge_base/7-1/creating-ios-themes).
