...
[the Screenlet creation tutorials](/docs/7-1/tutorials/-/knowledge_base/t/creating-ios-screenlets). 
...
4. Update your View class or View Model protocol to account for the new action. 
   ...
   [support multiple Themes](/docs/7-1/tutorials/-/knowledge_base/t/supporting-multiple-themes-in-your-ios-screenlet). 
...
6. Create a new Interactor class for the new action. To do this, use the same 
   ...
   [Screenlet creation tutorial](/docs/7-1/tutorials/-/knowledge_base/t/creating-the-ios-screenlets-interactor). 
