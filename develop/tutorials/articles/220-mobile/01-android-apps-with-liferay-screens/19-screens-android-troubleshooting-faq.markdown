...
4.  Connect failed: ECONNREFUSED (Connection refused), or 
   `org.apache.http.conn.HttpHostConnectException`
    ...
    available. If you've 
    [overridden the default IP address in `server_context.xml`](/docs/7-1/tutorials/-/knowledge_base/t/preparing-android-projects-for-liferay-screens#configuring-communication-with-liferay), 
...
4.  How do I create a new Screenlet?
    ...
    [here](/docs/7-1/tutorials/-/knowledge_base/t/creating-android-screenlets).

5.  How can I customize a Screenlet?

    You can customize Screenlets by creating new Views. Fortunately, there are 
    [tutorials](/docs/7-1/tutorials/-/knowledge_base/t/creating-android-views) 
    for this! 
