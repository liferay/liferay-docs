...
[liferay-gradle](/docs/7-0/tutorials/-/knowledge_base/t/liferay-sample-modules)
plugin is applied to it. See the
[Gradle](/docs/7-0/reference/-/knowledge_base/r/gradle) reference article for a
...
and
[Deploying Modules with Liferay @ide@](/docs/7-0/tutorials/-/knowledge_base/t/deploying-modules-with-liferay-ide)
tutorials, respectively.
