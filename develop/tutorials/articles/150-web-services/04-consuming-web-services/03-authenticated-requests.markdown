...
and 
[collections](/docs/7-1/tutorials/-/knowledge_base/t/working-with-collections-of-data). 
...
[Authorization Account Access with OAuth 2](/docs/7-1/deploy/-/knowledge_base/d/authorizing-account-access-with-oauth2). 
