...
The 
[`<liferay-frontend:management-bar-buttons>` tag](@app-ref@/foundation/7.1-latest/taglibdocs/liferay-frontend/management-bar-buttons.html) 
...
The 
[`<liferay-frontend:management-bar-sidenav-toggler-button>` tag](@app-ref@/foundation/7.1-latest/taglibdocs/liferay-frontend/management-bar-sidenav-toggler-button.html) 
implements slide-out navigation for the info button.

The 
[`<liferay-frontend:management-bar-display-buttons>` tag](@app-ref@/foundation/7.1-latest/taglibdocs/liferay-frontend/management-bar-display-buttons.html) 
...
The 
[`<liferay-frontend:management-bar-filters>` tag](@app-ref@/foundation/7.1-latest/taglibdocs/liferay-frontend/management-bar-filters.html) 
...
Finally, the 
[`<liferay-frontend:management-bar-action-buttons>` tag](@app-ref@/foundation/7.1-latest/taglibdocs/liferay-frontend/management-bar-action-buttons.html) 
