...
https://github.com/liferay/liferay-docs/tree/6.2.x/develop/tutorials/code/tutorials-sdk/portlets/liferay-ui-02-end-my-greeting-portlet

On completing this tutorial, the example portlet looks like the portlet at ...
https://github.com/liferay/liferay-docs/tree/6.2.x/develop/tutorials/code/tutorials-sdk/portlets/localize-use-lang-keys-my-greeting-portlet
-->
...
[`view.jsp`](https://github.com/liferay/liferay-docs/blob/6.2.x/develop/tutorials/code/tutorials-sdk/portlets/localize-use-lang-keys-my-greeting-portlet/docroot/view.jsp)
