...
| [the same way they did for Liferay Portal 6.x](/docs/7-0/tutorials/-/knowledge_base/t/optimizing-app-upgrade-processes#understanding-liferay-portal-6-upgrade-processes).
...
or Ivy `ivy.xml` file), 
[add a dependency](/docs/7-0/tutorials/-/knowledge_base/t/configuring-dependencies) 
on the 
...
application,
[create and register a Bundle Activator](/docs/7-0/tutorials/-/knowledge_base/t/upgrade-processes-for-former-service-builder-plugins)
...
upgraded for [Service Builder](/docs/7-0/tutorials/-/knowledge_base/t/what-is-service-builder)
services.
...
[Upgrade Processes for Former Service Builder Plugins](/docs/7-0/tutorials/-/knowledge_base/t/upgrade-processes-for-former-service-builder-plugins)
...
[Migrating Data Upgrade Processes to the New Framework for Modules](/docs/7-0/tutorials/-/knowledge_base/t/optimizing-app-upgrade-processes)
