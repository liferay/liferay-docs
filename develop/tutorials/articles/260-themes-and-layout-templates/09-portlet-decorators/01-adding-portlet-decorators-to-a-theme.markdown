...
does not define any portlet decorators, none will be available. It is
...
-   Decorate: this is the default Application Decorator when using the
    ...
    wrapped in a white box with a border and the portlet custom
...
-   Borderless: when this decorator is applied, the portlet is no
    longer wrapped in a white box, but the portlet custom title is
...
Adding Portlet Decorators to your theme is quite similar to adding
...
The first thing you'll need to do is declare the Portlet Decorators in your
...
in Liferay 7 contains the information and rules to add Portlet Decorators
