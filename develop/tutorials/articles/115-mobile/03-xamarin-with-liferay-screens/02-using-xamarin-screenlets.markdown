...
You can start using Screenlets once you've  [prepared](/docs/7-0/tutorials/-/knowledge_base/t/preparing-xamarin-projects-for-liferay-screens) 
your Xamarin project to use Liferay Screens. The Screenlet reference 
documentation describes the available Screenlets: 

-   [Screenlets in Liferay Screens for Android](/docs/7-0/reference/-/knowledge_base/r/screenlets-in-liferay-screens-for-android)
-   [Screenlets in Liferay Screens for iOS](/docs/7-0/reference/-/knowledge_base/r/screenlets-in-liferay-screens-for-ios)
...
3.  To configure your app to listen for events the Screenlet triggers, implement 
    ...
    to the 
    [Screenlet's reference documentation](/docs/7-0/reference/-/knowledge_base/r/screenlets-in-liferay-screens-for-android) 
