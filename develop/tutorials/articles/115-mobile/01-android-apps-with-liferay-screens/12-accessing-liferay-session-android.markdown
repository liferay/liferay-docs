...
[Methods section](/docs/7-0/tutorials/-/knowledge_base/t/accessing-the-liferay-session-in-android#methods) 
...
[Login Screenlet for Android](/docs/7-0/reference/-/knowledge_base/r/loginscreenlet-for-android)
