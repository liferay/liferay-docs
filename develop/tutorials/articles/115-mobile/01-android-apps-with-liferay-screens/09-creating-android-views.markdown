...
[architecture](/docs/7-0/tutorials/-/knowledge_base/t/architecture-of-liferay-screens-for-android)
...
2.  Create a new custom View class named after the layout's root element. The
    ...
    [create a View class](/docs/7-0/tutorials/-/knowledge_base/t/creating-android-screenlets#creating-the-screenlets-view-class).
