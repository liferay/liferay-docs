...
The 
[Rendering Web Content](/docs/7-0/tutorials/-/knowledge_base/t/rendering-web-content-in-your-android-app) 
...
[inserting any Screenlet in your app](/docs/7-0/tutorials/-/knowledge_base/t/using-screenlets-in-android-apps): 
...
1.  Insert the Screenlet's XML in the layout of the activity or fragment you 
    ...
    [the Attributes section](/docs/7-0/reference/-/knowledge_base/r/web-screenlet-for-android#attributes) 
...
| [the Configuration section](/docs/7-0/reference/-/knowledge_base/r/web-screenlet-for-android#configuration)
...
[Using Web Screenlet with Cordova in Your Android App](/docs/7-0/tutorials/-/knowledge_base/t/using-web-screenlet-with-cordova-in-your-android-app)

[Using Screenlets in Android Apps](/docs/7-0/tutorials/-/knowledge_base/t/using-screenlets-in-android-apps)

[Rendering Web Content in Your Android App](/docs/7-0/tutorials/-/knowledge_base/t/rendering-web-content-in-your-android-app)
