...
[Web Content Display Screenlet reference documentation](/docs/7-0/reference/-/knowledge_base/r/webcontentdisplayscreenlet-for-ios). 
...
[templates](/docs/7-0/user/-/knowledge_base/u/designing-uniform-content) 
...
To render 
[structured](/docs/7-0/user/-/knowledge_base/u/designing-uniform-content) 
...
1. [Create a theme](/docs/7-0/tutorials/-/knowledge_base/t/creating-ios-themes) 
...
[Web Content List Screenlet reference documentation](/docs/7-0/reference/-/knowledge_base/r/web-content-list-screenlet-for-ios). 
...
- To render Asset List Screenlet with `WebContent` objects, you must create your 
  ...
  [Asset List Screenlet reference documentation](/docs/7-0/reference/-/knowledge_base/r/assetlistscreenlet-for-ios) 
...
[Web Content Display Screenlet for iOS](/docs/7-0/reference/-/knowledge_base/r/webcontentdisplayscreenlet-for-ios)

[Web Content List Screenlet for iOS](/docs/7-0/reference/-/knowledge_base/r/web-content-list-screenlet-for-ios)

[Asset List Screenlet for iOS](/docs/7-0/reference/-/knowledge_base/r/assetlistscreenlet-for-ios)
