...
For example, 
[Login Screenlet's](/docs/7-0/reference/-/knowledge_base/r/loginscreenlet-for-ios) 
...
[Forgot Password Screenlet's](/docs/7-0/reference/-/knowledge_base/r/forgotpasswordscreenlet-for-ios) 
...
when you 
[add an action to your Screenlet](/docs/7-0/tutorials/-/knowledge_base/t/adding-screenlet-actions), 
...
[see the Configuring Communication with Liferay section](/docs/7-0/tutorials/-/knowledge_base/t/preparing-ios-projects-for-liferay-screens#configuring-communication-with-liferay) 
...
[the architecture tutorial](/docs/7-0/tutorials/-/knowledge_base/t/architecture-of-liferay-screens-for-ios).
