...
[staged models](/docs/7-1/tutorials/-/knowledge_base/t/understanding-staged-models).
...
the
[Developing Portlet Data Handlers](/docs/7-1/tutorials/-/knowledge_base/t/developing-portlet-data-handlers).
