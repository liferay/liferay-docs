---
header-id: configuring-a-basic-permissions-scheme
---
...
Navigate to the
[Configuring Your Permissions Scheme](/docs/6-2/tutorials/-/knowledge_base/t/configuring-your-permissions-scheme)
