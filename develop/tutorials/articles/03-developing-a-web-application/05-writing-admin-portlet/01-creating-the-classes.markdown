...
As described in the 
[product menu tutorial](/docs/7-0/tutorials/-/knowledge_base/t/customizing-the-product-menu), 
...
[product menu tutorial](/docs/7-0/tutorials/-/knowledge_base/t/customizing-the-product-menu)
and the 
[control menu tutorial](/docs/7-0/tutorials/-/knowledge_base/t/customizing-the-control-menu).
