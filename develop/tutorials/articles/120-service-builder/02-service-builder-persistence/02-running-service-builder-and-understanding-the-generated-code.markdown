...
you specfied for them in the `service.xml`. You won't have to modify more
than three classes for each entity. These modifiable classes are `[ENTITY_NAME]LocalServiceImpl`, `[ENTITY_NAME]ServiceImpl`, `[ENTITY_NAME]Impl`.
