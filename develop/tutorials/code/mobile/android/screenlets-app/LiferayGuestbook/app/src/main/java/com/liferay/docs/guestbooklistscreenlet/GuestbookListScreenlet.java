...
public class GuestbookListScreenlet extends BaseListScreenlet<GuestbookModel, GuestbookListInteractor> {
    ...
    public GuestbookListScreenlet(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    // Service call fails if no argument is passed to start method here
    @Override
