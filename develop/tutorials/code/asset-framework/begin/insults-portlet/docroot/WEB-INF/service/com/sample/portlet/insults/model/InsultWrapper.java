...
package com.sample.portlet.insults.model;
...
public class InsultWrapper implements Insult, ModelWrapper<Insult> {
	...
	*/
	...
	@Override
	public int compareTo(com.sample.portlet.insults.model.Insult insult) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.sample.portlet.insults.model.Insult> toCacheModel() {
		return _insult.toCacheModel();
	}

	@Override
	public com.sample.portlet.insults.model.Insult toEscapedModel() {
		return new InsultWrapper(_insult.toEscapedModel());
	}

	@Override
	public com.sample.portlet.insults.model.Insult toUnescapedModel() {
