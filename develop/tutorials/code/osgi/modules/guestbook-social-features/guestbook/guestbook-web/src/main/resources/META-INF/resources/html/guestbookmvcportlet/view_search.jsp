    ...
    <aui:form action="<%= searchURL %>" cssClass="container-fluid-1280" method="get" name="fm">
    ...
    />
        ...
        <div class="search-form">
            <span class="aui-search-bar">
                ...
                <aui:button css="btn-lg" type="submit" value="search" />
            </span>
        </div>
    </aui:form>
    ...
    <%
            if (Validator.isNotNull(keywords)) {
                    PortalUtil.addPortletBreadcrumbEntry(request, LanguageUtil.get(
                    		request, "search") + ": " + keywords, currentURL);
            }
    %>
