...
public class TaskClp extends BaseModelImpl<Task> implements Task {
	...
	public void setRoadieResponse(String roadieResponse) {
		...
		if (_taskRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setRoadieResponse",
						String.class);

				method.invoke(_taskRemoteModel, roadieResponse);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setInventoryResponse(String inventoryResponse) {
		...
		if (_taskRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setInventoryResponse",
						String.class);

				method.invoke(_taskRemoteModel, inventoryResponse);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setRoadieResponse(getRoadieResponse());
		clone.setInventoryResponse(getInventoryResponse());
