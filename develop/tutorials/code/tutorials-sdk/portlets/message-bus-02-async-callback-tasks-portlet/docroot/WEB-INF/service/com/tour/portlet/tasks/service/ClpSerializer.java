...
import com.tour.portlet.tasks.model.InventoryClp;
import com.tour.portlet.tasks.model.SetupClp;
import com.tour.portlet.tasks.model.TaskClp;
...
public class ClpSerializer {
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.tour.portlet.tasks.model.impl.InventoryImpl")) {
			return translateOutputInventory(oldModel);
		}

		if (oldModelClassName.equals(
					"com.tour.portlet.tasks.model.impl.SetupImpl")) {
			return translateOutputSetup(oldModel);
		}

		if (oldModelClassName.equals(
					"com.tour.portlet.tasks.model.impl.TaskImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.tour.portlet.tasks.NoSuchInventoryException")) {
			return new com.tour.portlet.tasks.NoSuchInventoryException();
		}

		if (className.equals("com.tour.portlet.tasks.NoSuchSetupException")) {
			return new com.tour.portlet.tasks.NoSuchSetupException();
		}

		if (className.equals("com.tour.portlet.tasks.NoSuchTaskException")) {
			return new com.tour.portlet.tasks.NoSuchTaskException();
		}
