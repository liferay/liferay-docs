...
<aui:form action="<%= editTaskURL %>" method="POST" name="fm">
    <aui:fieldset>
        ...
        <aui:input name="roadieResponse" type="hidden" value='<%= task == null ? "" : task.getRoadieResponse() %>'/>
        
        <aui:input name="inventoryResponse" type="hidden" value='<%= task == null ? "" : task.getInventoryResponse() %>'/>
