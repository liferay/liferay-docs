...
public class EventLocalServiceImpl extends EventLocalServiceBaseImpl {
	...
	public List<Event> findByEventNameEventDescriptionLocationNameDQ(
			String eventName, String eventDescription, String locationName) {
		
		return EventFinderUtil.findByEventNameEventDescriptionLocationNameDQ(
				eventName, eventDescription, locationName);
	}
