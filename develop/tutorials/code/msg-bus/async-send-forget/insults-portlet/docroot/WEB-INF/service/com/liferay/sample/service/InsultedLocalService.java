...
/**
 * Provides the local service interface for Insulted. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nickgaskill
 * @see InsultedLocalServiceUtil
...
public interface InsultedLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InsultedLocalServiceUtil} to access the insulted local service. Add custom service methods to {@link com.liferay.sample.service.impl.InsultedLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
