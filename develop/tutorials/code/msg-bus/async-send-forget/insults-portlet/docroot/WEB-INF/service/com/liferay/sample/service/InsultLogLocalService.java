...
/**
 * Provides the local service interface for InsultLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nickgaskill
 * @see InsultLogLocalServiceUtil
...
public interface InsultLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InsultLogLocalServiceUtil} to access the insult log local service. Add custom service methods to {@link com.liferay.sample.service.impl.InsultLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
