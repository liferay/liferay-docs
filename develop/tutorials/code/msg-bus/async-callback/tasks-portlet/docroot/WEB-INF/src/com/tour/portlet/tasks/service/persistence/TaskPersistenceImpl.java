...
import com.tour.portlet.tasks.NoSuchTaskException;
import com.tour.portlet.tasks.model.Task;
import com.tour.portlet.tasks.model.impl.TaskImpl;
import com.tour.portlet.tasks.model.impl.TaskModelImpl;
...
public class TaskPersistenceImpl extends BasePersistenceImpl<Task>
	...
	@Override
	public Task updateImpl(com.tour.portlet.tasks.model.Task task)
	...
	protected Task toUnwrappedModel(Task task) {
		...
		taskImpl.setRoadieResponse(task.getRoadieResponse());
		taskImpl.setInventoryResponse(task.getInventoryResponse());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.tour.portlet.tasks.model.Task")));
