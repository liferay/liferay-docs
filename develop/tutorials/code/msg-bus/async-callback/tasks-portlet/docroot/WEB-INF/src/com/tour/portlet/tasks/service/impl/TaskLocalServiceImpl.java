...
public class TaskLocalServiceImpl extends TaskLocalServiceBaseImpl {
	...
	public Task addTask(String name, String description, String status, ServiceContext serviceContext)
	  throws PortalException, SystemException {
	    ...
	    task.setRoadieResponse("No");
	    task.setInventoryResponse("No");
	...
	public Task updateTask(long taskId, String name, String description, String status, String roadieResponse, String inventoryResponse, ServiceContext serviceContext)
			  throws PortalException, SystemException {
	    ...
	    task.setDescription(description);
	    task.setStatus(status);
	    task.setRoadieResponse(roadieResponse);
	    task.setInventoryResponse(inventoryResponse);
