...
/**
 * Provides the local service interface for Setup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nickgaskill
 * @see SetupLocalServiceUtil
...
public interface SetupLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SetupLocalServiceUtil} to access the setup local service. Add custom service methods to {@link com.tour.portlet.tasks.service.impl.SetupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
