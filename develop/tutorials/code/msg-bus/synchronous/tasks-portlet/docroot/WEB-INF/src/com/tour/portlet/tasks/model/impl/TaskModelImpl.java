...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Task_Task (taskId LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null,status VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG)";
