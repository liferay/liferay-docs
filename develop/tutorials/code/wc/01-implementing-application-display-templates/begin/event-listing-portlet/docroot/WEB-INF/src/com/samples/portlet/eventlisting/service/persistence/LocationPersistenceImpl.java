...
import com.samples.portlet.eventlisting.NoSuchLocationException;
import com.samples.portlet.eventlisting.model.Location;
import com.samples.portlet.eventlisting.model.impl.LocationImpl;
import com.samples.portlet.eventlisting.model.impl.LocationModelImpl;
...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
	 ...
	 */
	@Override
	public List<Location> filterFindByGroupId(long groupId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<Location> filterFindByGroupId(long groupId, int start, int end)
		throws SystemException {
	...
	public List<Location> filterFindByGroupId(long groupId, int start, int end,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_LOCATION_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(LocationModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			return (List<Location>)QueryUtil.list(q, getDialect(), start, end);
		}
		catch (Exception e) {
			throw processException(e);
		}
	 ...
	 */
	@Override
	public Location[] filterFindByGroupId_PrevAndNext(long locationId,
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, location,
					groupId, orderByComparator, true);

			array[1] = location;

			array[2] = filterGetByGroupId_PrevAndNext(session, location,
	...
	protected Location filterGetByGroupId_PrevAndNext(Session session,
		Location location, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public int filterCountByGroupId(long groupId) throws SystemException {
		...
		query.append(_FILTER_SQL_COUNT_LOCATION_WHERE);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.samples.portlet.eventlisting.model.Location")));
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN = "location.locationId";
	private static final String _FILTER_SQL_SELECT_LOCATION_WHERE = "SELECT DISTINCT {location.*} FROM Event_Location location WHERE ";
	private static final String _FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_1 =
		"SELECT {Event_Location.*} FROM (SELECT DISTINCT location.locationId FROM Event_Location location WHERE ";
	private static final String _FILTER_SQL_SELECT_LOCATION_NO_INLINE_DISTINCT_WHERE_2 =
		") TEMP_TABLE INNER JOIN Event_Location ON TEMP_TABLE.locationId = Event_Location.locationId";
	private static final String _FILTER_SQL_COUNT_LOCATION_WHERE = "SELECT COUNT(DISTINCT location.locationId) AS COUNT_VALUE FROM Event_Location location WHERE ";
	private static final String _FILTER_ENTITY_ALIAS = "location";
	private static final String _FILTER_ENTITY_TABLE = "Event_Location";
	private static final String _ORDER_BY_ENTITY_ALIAS = "location.";
	private static final String _ORDER_BY_ENTITY_TABLE = "Event_Location.";
