...
import com.samples.portlet.eventlisting.NoSuchEventException;
import com.samples.portlet.eventlisting.model.Event;
import com.samples.portlet.eventlisting.model.impl.EventImpl;
import com.samples.portlet.eventlisting.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	@Override
	public Event updateImpl(com.samples.portlet.eventlisting.model.Event event)
		throws SystemException {
		event = toUnwrappedModel(event);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.samples.portlet.eventlisting.model.Event")));
