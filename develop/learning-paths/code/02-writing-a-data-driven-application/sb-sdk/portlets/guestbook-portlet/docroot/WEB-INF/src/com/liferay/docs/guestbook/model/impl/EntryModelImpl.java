...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	...
	public static final String TABLE_SQL_CREATE = "create table GB_Entry (entryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,email VARCHAR(75) null,entry VARCHAR(75) null,guestbookId LONG)";
