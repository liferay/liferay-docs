...
In this learning path, we'll explore the following topics:
...
For information on additional topics, please consult the following tutorials:

- Using Liferay IDE's Service Builder editor (can we call it a `service.xml`
  editor?
...
service design. In this article, we'll discuss some of the main benefits of
