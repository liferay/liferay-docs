...
[assets](/docs/7-0/tutorials/-/knowledge_base/t/asset-framework) 
...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See the [Offline section](/docs/7-0/reference/-/knowledge_base/r/assetlistscreenlet-for-ios#offline) for details. |
