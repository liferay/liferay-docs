...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See [the Offline section](/docs/7-0/reference/-/knowledge_base/r/comment-add-screenlet-for-ios#offline) for details. |
