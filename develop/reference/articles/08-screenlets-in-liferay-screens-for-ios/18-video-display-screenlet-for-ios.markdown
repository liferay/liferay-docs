...
| `offlinePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/7-0/reference/-/knowledge_base/r/video-display-screenlet-for-ios#offline) for details. |
