...
| ------- | ------ | ----- |
| `DDMStructureService` | `getStructure` | Load form |
| `DDMStructureService` | `getDdlRecord` | Load record |
...
| `cachePolicy` | `string` | The offline mode setting. See the [Offline section](/docs/6-2/reference/-/knowledge_base/r/ddlformscreenlet-for-android#offline) for details. |
