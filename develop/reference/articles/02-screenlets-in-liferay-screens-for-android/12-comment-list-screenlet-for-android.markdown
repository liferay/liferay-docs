...
| `cachePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/6-2/reference/-/knowledge_base/r/comment-list-screenlet-for-android#offline) for details. |
