---
header-id: asset-display-screenlet-for-android
---
...
[the Listener section of this document](/docs/6-2/reference/-/knowledge_base/r/asset-display-screenlet-for-android#listener) 
for details. 
