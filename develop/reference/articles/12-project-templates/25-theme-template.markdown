...
The generated theme is functional and is deployable to a @product@ instance. To build upon the generated app,
modify the project by adding logic and additional files to the folders outlined
above. You can visit the
[Theme sample project](/develop/reference/-/knowledge_base/7-0/theme) for a more
