...
The Metal.js npm Portlet sample provides a portlet that uses [Metal.js](https://metaljs.com/) framework to render its output.

![Screenshot of Metal.js npm Portlet](screenshot.png)
