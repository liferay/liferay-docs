...
The Angular npm Portlet sample provides a portlet that uses [Angular](https://angular.io/) framework to render its output.

![Screenshot of Angular npm Portlet](screenshot.png)
