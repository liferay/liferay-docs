...
| `cachePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/7-0/reference/-/knowledge_base/r/image-display-screenlet-for-android#offline) for details. |
