...
| `offlinePolicy` | `string` | The offline mode setting. See [the Offline section](/develop/reference/-/knowledge_base/7-1/pdf-display-screenlet-for-ios#offline) for details. |
