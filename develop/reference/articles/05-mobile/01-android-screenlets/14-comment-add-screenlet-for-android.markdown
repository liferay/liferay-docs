---
header-id: comment-add-screenlet-for-android
---
...
| `cachePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/7-1/reference/-/knowledge_base/r/comment-add-screenlet-for-android#offline) for details. |
