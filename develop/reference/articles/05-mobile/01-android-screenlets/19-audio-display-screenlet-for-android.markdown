# Audio Display Screenlet for Android [](id=audio-display-screenlet-for-android)
...
| `cachePolicy` | `string` | The offline mode setting. See [the Offline section](/develop/reference/-/knowledge_base/7-1/audio-display-screenlet-for-android#offline) for details. |
