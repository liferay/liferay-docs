...
[structures and templates](/docs/7-1/user/-/knowledge_base/u/designing-uniform-content), 
...
| `templateId` | `number` | The identifier of the template used to render the web content. This only applies to [structured web content](/docs/7-1/user/-/knowledge_base/u/designing-uniform-content). |
...
| `cachePolicy` | `string` | The offline mode setting. See the [Offline section](/docs/7-1/reference/-/knowledge_base/r/webcontentdisplayscreenlet-for-android#offline) for details. |
