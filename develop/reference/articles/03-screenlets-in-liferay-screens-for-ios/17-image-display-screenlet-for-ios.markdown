# Image Display Screenlet for iOS [](id=image-display-screenlet-for-ios)
...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See the [Offline section](/develop/reference/-/knowledge_base/6-2/image-display-screenlet-for-ios#offline) for details. |
