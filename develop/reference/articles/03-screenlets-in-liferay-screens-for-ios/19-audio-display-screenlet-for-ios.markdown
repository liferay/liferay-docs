...
| `offlinePolicy` | `string` | The offline mode setting. See [the Offline section](/docs/6-2/reference/-/knowledge_base/r/audio-display-screenlet-for-ios#offline) for details. |
