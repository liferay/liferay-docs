...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See [the Offline section](/docs/6-2/reference/-/knowledge_base/r/blogs-entry-display-screenlet-for-ios#offline) for details. |
