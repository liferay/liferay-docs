...
[the delegate section of this document](/docs/6-2/reference/-/knowledge_base/r/asset-display-screenlet-for-ios#delegate) 
for details. 
...
| `offlinePolicy` | `string` | The offline mode setting. The default value is `remote-first`. See [the Offline section](/docs/6-2/reference/-/knowledge_base/r/asset-display-screenlet-for-ios#offline) for details. |
