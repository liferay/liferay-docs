...
[validate modules](/docs/7-0/tutorials/-/knowledge_base/t/resolving-your-modules).
...
[export](/docs/7-0/tutorials/-/knowledge_base/t/exporting-packages) and/or
[import](/docs/7-0/tutorials/-/knowledge_base/t/importing-packages)
configuration of your modules. Also, see the
[Resolving Third Party Library Package Dependencies](/docs/7-0/tutorials/-/knowledge_base/t/adding-third-party-libraries-to-a-module)
...
the
[Depending on Third Party Libraries Not Included in @product@](/docs/7-0/tutorials/-/knowledge_base/t/modifying-the-target-platforms-capabilities#depending-on-third-party-libraries-not-included-in-product)
...
[generating a new custom distro JAR](/docs/7-0/tutorials/-/knowledge_base/t/modifying-the-target-platforms-capabilities#depending-on-a-customized-distribution-of-product).
