...
properties. [Blade CLI](/developer/reference/-/knowledge_base/7-2/blade-cli) is
...
- [Project template/archetype](/developer/reference/-/knowledge_base/7-2/theme-template)
  (Gradle/Maven-based)
...
to
[create Node.js-based themes inside workspace](/developer/reference/-/knowledge_base/7-2/building-node-js-themes-in-liferay-workspace)
or you can leverage it externally and copy themes into Workspace.

Workspace also offers a
[traditional Java-based theme approach](/developer/reference/-/knowledge_base/7-2/building-gradle-maven-themes-in-liferay-workspace)
