...
created with
[Blade CLI](/docs/7-2/reference/-/knowledge_base/reference/blade-cli) or Maven
using the
...
1.  Follow the
    ...
    [themes generated by the Theme Generator](/docs/7-2/reference/-/knowledge_base/reference/building-node-js-themes-in-liferay-workspace).
