...
[installed a Liferay server in Dev Studio](/docs/7-2/reference/-/knowledge_base/reference/installing-a-server-in-liferay-dev-studio).
...
These steps assume you've
[installed a Liferay server in IntelliJ](/docs/7-2/reference/-/knowledge_base/reference/installing-a-server-in-intellij-idea).
