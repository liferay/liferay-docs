...
that  segments users based on the title of the Knowledge Base articles they have
authored.
...
section with the Knowledge Base properties. Notice that the section's UI, 
