...
6.  Implement the `render` method, which is called when the inline display style 
    ...
    [Clay icon](/docs/7-2/frameworks/-/knowledge_base/frameworks/clay-icons). 
...
[a Clay link](/docs/7-2/frameworks/-/knowledge_base/frameworks/clay-labels-and-links) 
...
3.  From the request, get a `SocialBookmark` instance and the social bookmark's 
    ...
    [applying the social bookmark](/docs/7-2/frameworks/-/knowledge_base/frameworks/applying-social-bookmarks). 
...
4.  Add the Clay link. See the `clay:link` 
    ...
    [type](/docs/7-2/frameworks/-/knowledge_base/frameworks/clay-buttons#types) 
...
[Using the Clay Taglib in Your Portlets](/docs/7-2/frameworks/-/knowledge_base/frameworks/using-the-clay-taglib-in-your-portlets)
