...
model object. As the 
[intro](/docs/7-2/frameworks/-/knowledge_base/frameworks/documents-and-media-api)
explains, you'll use 
...
API by setting the 
[Service Context's](/docs/7-2/frameworks/-/knowledge_base/frameworks/understanding-servicecontext) 
