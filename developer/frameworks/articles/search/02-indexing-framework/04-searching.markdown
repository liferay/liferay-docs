...
good idea), query the localized fields at search time. 
...
The entity in thsi example has a title, subtitle, and content field. The
...
[`ModelPreFilterContributor`s](https://github.com/liferay/liferay-portal/blob/7.2.0-ga1/modules/apps/portal-search/portal-search-spi/src/main/java/com/liferay/portal/search/spi/model/query/contributor/ModelPreFilterContributor.java) 
...
time a query for the model entity is made. This one adds a filter for workflow
status:
