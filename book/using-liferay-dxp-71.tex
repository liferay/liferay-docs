...
\part{Discovering Analytics Cloud}
\include{discover-analytics-cloud}

% \pagenumbering{gobble}
\part{Deploying Liferay DXP}
% \pagenumbering{arabic}

\include{discover-deployment}

% \pagenumbering{gobble}
% \part{Developing On Liferay DXP}
% \pagenumbering{arabic}

% \include{develop-tutorials}
% \include{develop-reference}
